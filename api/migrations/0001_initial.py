# Generated by Django 3.2.7 on 2023-02-22 04:45
    ...
    operations = [
        ...
        migrations.RunSQL(
            sql=[(
                ...
                SELECT set_chunk_time_interval('api_sensorreading', INTERVAL '30 days');"
            )],
            reverse_sql=[(
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('author', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='runs', to=settings.AUTH_USER_MODEL)),
            ],
            options={
                'ordering': ['updated'],
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('run', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='input_runs', to='api.run')),
            ],
        ),
        migrations.CreateModel(
            name='InputOrder',
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('amount', models.DecimalField(decimal_places=2, max_digits=10)),
                ('inventory', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, to='api.inventory')),
                ('order', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, related_name='input_order', to='api.order')),
            ],
        ),
        migrations.CreateModel(
