...
from api.models import Customer, CustomerOrder, InputOrder, Delivery, Inventory, FileUpload
from api.serializers import InputOrderSerializer, CustomerOrderSerializer, CustomerSerializer, DeliverySerializer, InputOrderSerializer
