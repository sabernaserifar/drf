...
let fields = [
	['name', settings()], 
	['type', settings({help_text: 'E.g. Expedited, Overnight, Priority Mail, etc'})], 
	['status', settings({help_text: 'E.g. Delivered, Cancelled, Pending, etc'})],
	['carrier', settings({help_text: 'E.g. FedeX'})],
    ['tracking_number', settings({help_text: 'E.g. ABC123'}) ],
